...
function Car2({ items }) {
  ...
  return (
      ...
      <div id="carouselExample" className="ariba carousel slide">
...
<div class="col-8 booknow2">
        ...
        <button className="carousel-control-next car2next" type="button" data-bs-target="#carouselExample" data-bs-slide="next" onClick={handleNext}>
